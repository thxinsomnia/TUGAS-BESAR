<?php
    ...
    $kategori = mysqli_query($conn, "SELECT * FROM tab_kategori WHERE kategori_id = '".$_GET['id']."' ");
   ...
   <div class="section">
    <div class="container">
        ...
        <div class="box">
            ...
            <!-- UNTUK EDIT DATA PADA DATABASE -->
            <?php
                if(isset($_POST['submit'])){

                    $nama = ucwords($_POST['nama']);
                    
                    $update = mysqli_query($conn, "UPDATE tab_kategori SET
                                            kategori_name = '".$nama."'
